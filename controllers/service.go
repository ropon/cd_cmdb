...
func checkData(c *gin.Context, v interface{}) bool {
	if err := c.Bind(v); err != nil {
		utils.GinErrRsp(c, utils.ErrCodeParamInvalid, "参数有误:"+c.Errors.Last().Error())
		return false
	}
	return true
}
...
// @Router /cd_cmdb/api/v1/service [post]
...
// @Success 200
// @Router /cd_cmdb/api/v1/service/{id} [delete]
...
// @Router /cd_cmdb/api/v1/service/{id} [put]
...
// @Success 200 {object} models.Service "更新成功返回结果"
// @Router /cd_cmdb/api/v1/service/{id} [patch]
...
// @Router /cd_cmdb/api/v1/service [get]
...
// @Router /cd_cmdb/api/v1/service/{id} [get]
